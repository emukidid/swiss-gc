...
powerpc-eabi-gcc -O2 -ffunction-sections -mmultiple -mstring -c base\cardnull.c
...
powerpc-eabi-ld -o usbgecko.elf base.o usbgecko.o cardnull.o dvdqueue.o frag.o --section-start .text=0x80001800 --gc-sections
del *.o
