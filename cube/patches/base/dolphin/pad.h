...
#define PAD_COMBO_OSD_GCDIGITAL (PAD_BUTTON_X | PAD_BUTTON_L | PAD_BUTTON_R | PAD_BUTTON_RIGHT)
#define PAD_COMBO_OSD_GCVIDEO   (PAD_BUTTON_Y | PAD_BUTTON_X | PAD_BUTTON_L | PAD_BUTTON_R)
#define PAD_COMBO_RECALIBRATE   (PAD_BUTTON_Y | PAD_BUTTON_X | PAD_BUTTON_START)
