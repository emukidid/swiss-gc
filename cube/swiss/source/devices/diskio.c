...
const DISC_INTERFACE *driver[_VOLUMES] = { &__io_gcsda, &__io_gcsda, &__io_ataa, &__io_atab, &__io_wkf};
static bool disk_isInit[_VOLUMES] = {0,0,0,0,0};

// Disk caches
CACHE *cache[_VOLUMES] = {NULL, NULL, NULL, NULL, NULL};
