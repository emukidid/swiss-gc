...
.set VAR_SD_SHIFT,          0x09B8  // is the SD Card shift amount when issuing read cmds
...
extern char VAR_SD_SHIFT[1];         // is the SD Card shift amount when issuing read cmds
